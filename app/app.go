...
func NewFeeAbs(
	...
	keys := sdk.NewKVStoreKeys(
		...
		icahosttypes.StoreKey, icacontrollertypes.StoreKey, ibcfeetypes.StoreKey, intertxtypes.StoreKey,
	)
...
func (app *FeeAbs) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *FeeAbs) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *FeeAbs) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
