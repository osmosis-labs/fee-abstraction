...
osmosisd tx wasm store scripts/bytecode/ibc_stargate-aarch64.wasm --keyring-backend=test --from validator1 --chain-id testing --gas 10000000 --fees 25000stake --yes
...
#osmosisd tx wasm store scripts/bytecode/ibc_stargate-aarch64.wasm --keyring-backend=test --home=$HOME/.osmosisd --from validator1 --chain-id testing --gas 10000000 --fees 25000stake --yes
