...
import (
	...
	"github.com/notional-labs/fee-abstraction/v4/app/params"
)
...
Example:
	feeappd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "feeappd", "Home directory of the node's daemon configuration")
