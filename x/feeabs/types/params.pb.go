...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n1, err1 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.SwapPeriod, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.SwapPeriod):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
	...
	i--
	dAtA[i] = 0x1a
	n2, err2 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.QueryPeriod, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.QueryPeriod):])
	if err2 != nil {
		return 0, err2
	}
	i -= n2
...
func (m *Params) Size() (n int) {
	...
	l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.QueryPeriod)
	n += 1 + l + sovParams(uint64(l))
	l = github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.SwapPeriod)
	n += 1 + l + sovParams(uint64(l))
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(&m.QueryPeriod, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if err := github_com_cosmos_gogoproto_types.StdDurationUnmarshal(&m.SwapPeriod, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
