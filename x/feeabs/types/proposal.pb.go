...
func (m *PoolRoute) GetTokenOutDenom() string {
	if m != nil {
...
type HostChainFeeAbsConfig struct {
	...
	// pool id
	PoolRoute []PoolRoute `protobuf:"bytes,3,rep,name=pool_route,json=poolRoute,proto3" json:"pool_route"`
	// Frozen
...
func (m *HostChainFeeAbsConfig) GetPoolRoute() []PoolRoute {
	if m != nil {
		return m.PoolRoute
	}
	return nil
...
func (*SetHostZoneProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_b23c77c2b5aa1f89, []int{4}
}
...
func init() {
	proto.RegisterType((*PoolRoute)(nil), "feeabstraction.absfee.v1beta1.PoolRoute")
...
var fileDescriptor_b23c77c2b5aa1f89 = []byte{
	...
	,
}
...
func (m *PoolRoute) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TokenOutDenom) > 0 {
		...
		i = encodeVarintProposal(dAtA, i, uint64(len(m.TokenOutDenom)))
		i--
		dAtA[i] = 0x12
	}
	if m.PoolId != 0 {
...
func (m *HostChainFeeAbsConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PoolRoute) > 0 {
		for iNdEx := len(m.PoolRoute) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PoolRoute[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *HostChainFeeAbsConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PoolRoute", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PoolRoute = append(m.PoolRoute, PoolRoute{})
			if err := m.PoolRoute[len(m.PoolRoute)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
