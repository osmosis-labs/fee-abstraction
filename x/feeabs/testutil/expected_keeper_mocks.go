...
func (m *MockAccountKeeper) NewAccountWithAddress(ctx context.Context, addr types.AccAddress) types0.AccountI {
	m.ctrl.T.Helper()
...
func (m *MockClientKeeper) GetClientConsensusState(ctx context.Context, clientID string) (exported.ConsensusState, bool) {
	m.ctrl.T.Helper()
...
func (m *MockConnectionKeeper) GetConnection(ctx context.Context, connectionID string) (types3.ConnectionEnd, bool) {
	m.ctrl.T.Helper()
...
func (m *MockPortKeeper) BindPort(ctx context.Context, portID string) *types1.Capability {
	m.ctrl.T.Helper()
...
func (m *MockScopedKeeper) AuthenticateCapability(ctx context.Context, capability *types1.Capability, name string) bool {
	m.ctrl.T.Helper()
...
func (m *MockScopedKeeper) ClaimCapability(ctx context.Context, capability *types1.Capability, name string) error {
	m.ctrl.T.Helper()
...
func (m *MockScopedKeeper) GetCapability(ctx context.Context, name string) (*types1.Capability, bool) {
	m.ctrl.T.Helper()
...
func (m *MockChannelKeeper) ChanCloseInit(ctx context.Context, portID, channelID string, chanCap *types1.Capability) error {
	m.ctrl.T.Helper()
...
func (m *MockChannelKeeper) GetChannel(ctx context.Context, srcPort, srcChan string) (types4.Channel, bool) {
	m.ctrl.T.Helper()
...
func (m *MockChannelKeeper) SendPacket(ctx context.Context, channelCap *types1.Capability, sourcePort, sourceChannel string, timeoutHeight types2.Height, timeoutTimestamp uint64, data []byte) (uint64, error) {
	m.ctrl.T.Helper()
